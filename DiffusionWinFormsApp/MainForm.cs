...
public partial class MainForm : Form
{
    ...
    List<DiffusionBall> balls = new List<DiffusionBall>();
    public Random random = new Random();
    private int amountBall = 20;    
    public MainForm()
    {
        InitializeComponent();
    ...
    private void ChooseLeft()
    {
        ...
        billyardRed.Start();
        billyardRed.centerX = random.Next(billyardRed.LeftSide(), ClientSize.Width / 2 - billyardRed.radius);
    ...
    private void ChooseRight()
    {
        ...
        billyardGreen.Start();
        billyardGreen.centerX = random.Next(ClientSize.Width / 2 - billyardGreen.radius, billyardGreen.RightSide());
    ...
    private void EndOfShuffle()
    {
        ...
        if (redLeftCount == greenLeftCount && redRightCount == greenRightCount
                && redLeftCount + greenLeftCount + redRightCount + greenRightCount == amountBall)
        {
            foreach (var ball in balls)
            {
                ball.Stop();
